...
public class RandomGUID extends Object {
	...
	public String valueAfterMD5_16 = "";
...
//		mySecureRand = new SecureRandom();
		try {
			mySecureRand = SecureRandom.getInstance("SHA1PRNG");
	...
	private void getRandomGUID(boolean secure) {
		...
		try {
			...
			valueAfterMD5_16 = valueAfterMD5.substring(8, 24);
	...
	public static void main(String args[]) {
		for (int i = 0; i < 100; i++) {
			...
			System.out.println("rawGUID=" + myGUID.valueAfterMD5_16);
